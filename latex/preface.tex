...
\noindent \marginnote{Vicare Scheme, developed by Marco Maggi, is a fork of my friend Abdulaziz Ghuloum's Ikarus Scheme: \url{http://marcomaggi.github.io/vicare.html}}
%
All code has been tested under Vicare Scheme, and should run with little or no modification under other implementations that are compatible with the \RfiveRSsp or \RsixRSsp\marginnote{\RfiveRSsp Standard: \url{http://www.schemers.org/Documents/Standards/R5RS/}\\\noindent\RsixRSsp Standard: \url{http://www.r6rs.org/}} Scheme standards.
