...
%
To\marginnote{In this sense the book emulates Benjamin Pierce's outstanding \emph{TAPL}, which is about types in programming languages, but also contains excellent introductions to other PL-related topics:\cite{tapl}} make the book as accessible as possible, all of these concepts are
