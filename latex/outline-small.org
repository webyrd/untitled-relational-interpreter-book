...
Stick to the goal: explaining the relational Scheme interpreter so
that a reader understands the code, can experiment with it, etc.
Anything that doesn't advance that goal needs to be cut, put in a
margin note, made an exercise, or moved to an appendix.
