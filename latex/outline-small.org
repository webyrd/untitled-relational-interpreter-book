...
** Intro
* PART I: SCHEME [the parts we'll need]
...
mutual recursion
other useful and interesting parts of Scheme
  quasiquote & unquote
  let
  letrec
  varargs
...
syntactic extension
  pattern matching [what did I mean by this?  pmatch?]
  embedded domain-specific languages
* PART II: TRANSFORMING SCHEME PROGRAMS [just the transformations we'll need]
