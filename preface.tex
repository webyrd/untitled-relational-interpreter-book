...
%% This book presents the complete code\marginnote{All code presented in
%%   the book is available at the book's GitHub repository:
%%   \url{https://github.com/webyrd/relational-programming-in-miniKanren}}
%% for the minimal implementation of core miniKanren, along with
%% implementations of various extensions to the core language.
%% %
%% Presenting multiple implementations helps separate optimizations and
%% optional extensions from essential implementation concepts, at the
%% risk of making unclear which implementation to use for running a given
%% relational program.
%% %
%% To prevent this problem, every relational program presented includes a
%% pointer to the implementation that was used to test it.
%% %
%% In practice, any implementation that supports the miniKanren language
%% features used in the relation usually suffices.

%% If you are comfortable using Scheme, I suggest you follow along by
%% running the relational programs using the miniKanren implementations
%% presented in the book.
%% %
%% If you prefer to use cKanren, you should be able to run the relations
%% in Racket with few or no changes to the code (although the order of
%% answers returned, or the formatting of constraints in the answers,
