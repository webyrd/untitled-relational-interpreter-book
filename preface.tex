...
%
Informally, we say that the call \mbox{\scheme|(+o 3 4 z)|} runs the \scheme|+o| relation ``forwards,'' while the calls \mbox{\scheme|(+o 3 y 7)|}, \mbox{\scheme|(+o x y 7)|}, and \mbox{\scheme|(+o x y z)|} run \scheme|+o| ``backwards.''
...
of Scheme. Running \scheme|evalo| forwards, the call
