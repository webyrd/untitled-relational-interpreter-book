...
%
To prevent this problem, I include a pointer to the recommended
implementation to use for each relation.
%
In practice, any implementation that supports the miniKanren language
features used in the relation is usually sufficient.
