...
This is a book about \emph{relational programming}. Just as functional programs model mathematical functions, relational programs model mathematical relations.
