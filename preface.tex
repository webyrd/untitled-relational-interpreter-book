...
%
For example, consider a two-argument variant of Scheme's addition function: \mbox{\scheme|(+ 3 4) $\Rightarrow$ 7|}.
%
A relational version of addition, which we'll call \scheme|+o|, takes three arguments: \mbox{\scheme|(+o 3 4 x)|}.
%
Here \scheme|x| is a \emph{logic variable} that represents the result
of adding the first two arguments of \scheme|+o|; in this case,
\scheme|x| will be associated with \schemeresult|7|.
