...
%%
% In elementary school I was taught the weakest way to solve
% a multiplication problem: to just solve it.
%
...
% math or CS course: can rephrase that problem as one of adding 0's to a string representing a number in binary.
...
%% Consider multiplication.
%% %
%% In elementary school we learned to multiply small whole numbers by
%% memorization: we memorized the fact that 3 times 4 is 12.
%% %
%% We also learned how to mutiply larger numbers digit-by-digit, allowing
%% us to break up a large problem into several smaller problems we could
%% solve using our mental collection of facts.
%% %
%% We learned to just solve the problem, most likely without realizing
%% that we were using fundamental notions of computation: following an
%% algorithm, using a lookup table, and using recursion to make a complex
%% problem simpler.
...
%In this book we will explore fundamental ideas in computer science
%from the perspective of \emph{relational programming}.
