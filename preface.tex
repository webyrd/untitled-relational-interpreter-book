...
The goals for this book are several-fold:

\begin{enumerate}
\item to make relational programming accessible to a broader audience;
\item to describe the current state of the miniKanren language, and
  its Constraint Logic Programming (CLP) extensions;
\item to present a variety of relational programs that exemplify the
  relational style and introducing important relational idioms;
\item to explain how to derive miniKanren relations from pure Scheme
  functions, in a systematic manner;
\item to give a detailed explanation of the latest implementation of
  core miniKanren, and to show how to hack the implementation to
  change the behavior of miniKanren, or add new operators;
\item to explain how constraint solving works in the cKanren
  Constraint Logic Programming framework, and show how to design and
  implement new constraint domains;
\item to demonstrate how to debug miniKanren relations;
\item to explain how miniKanren differs from related languages,
  including Prolog, Curry, Mercury, and Oz;
\item to describe important open problems in relational programming, and
  limitations of miniKanren;
\item to\marginnote{Describing these programming languages concepts
  has the important side effect of making accessible the academic
  papers presented on miniKanren.} use relational programming to
  explain important and interesting concepts from programming
  languages, such as interpreters, type inferencers, and
  Continuation-Passing Style.
\end{enumerate}

% An important goal of the book is to make other resources on
% miniKanren more accessible.  
