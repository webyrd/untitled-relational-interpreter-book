...
%
For example, consider a two-argument variant of Scheme's addition function: \scheme|(+ 3 4) $\Rightarrow$ 7|.
%
A relational version of addition, which we'll call \scheme|+o|, takes three arguments: \scheme|(+o 3 4 x)|.
%
