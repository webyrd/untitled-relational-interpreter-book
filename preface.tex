...
\item give a detailed explanation of the latest implementation of
...
\item use \marginnote{Describing these programming languages concepts
  has the important side effect of making accessible the academic
  papers presented on miniKanren.} relational programming to explain
  important and interesting concepts from programming languages, such
  as interpreters, type inferencers, and Continuation-Passing Style.
\end{enumerate}
