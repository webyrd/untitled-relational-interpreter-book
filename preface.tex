...
This book contains mutiple implementations of the minimal, core
miniKanren language, along with implementations of various extensions
to that core language.
%
