...
%
The perspective taken in this book is somewhat different, and is based on generalizing functions to relations; in other words, this book borrows more from functional programming than from logic programming or relational databases.
