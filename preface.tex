...
%
Relational\marginnote{If you know nothing about logic programming, relational algebra, or databases, \emph{don't panic!} This book only assumes that you can write simple recursive programs in a functional language, and have a reading knowledge of Racket or Scheme.  See the \emph{Audience} section below for details.} programming is intimately related to both logic programming
...
of Racket, \scheme|evalo|. Running \scheme|evalo| forwards, the call\marginnote{As might be expected, \scheme|evalo| will interpret the quoted list \mbox{\schemeresult|(+ x 2)|} as the call \mbox{\scheme|(+o x 2 val)|}, where the logic variable \scheme|x| is associated with \schemeresult|4|.}
...
Racket expressions that \emph{evaluate} to 6, while
\mbox{\scheme|(evalo exp exp)|} generates \emph{quines}, which are Racket expressions that evaluate to themselves.
...
programming language, such as Racket, Scheme, Clojure, Lisp, ML, or
Haskell.  I also assume you have a reading knowledge of Racket or Scheme.
%
...
\emph{How to Design Programs}\marginnote{Online second edition of \emph{How to Design Programs}: \url{http://www.ccs.neu.edu/home/matthias/HtDP2e/}}
...
Racket or Scheme, the beginning of \emph{Structure and Interpretation
  of Computer Programs} should get you up to speed, while the online
Racket documentation\marginnote{Online Racket documentation:\\\noindent\url{http://docs.racket-lang.org/}}
and \emph{The Scheme Programming Language, 4th
  Edition}\cite{Dybvig:2009:SPL:1618542}\marginnote{(full text at
  \url{http://www.scheme.com/tspl4/})} describe the finer points of
each language.
...
I have chosen Racket\marginnote{http://racket-lang.org/} as the host
