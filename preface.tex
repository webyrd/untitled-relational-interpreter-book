...
%
A relational version of addition, which we'll call \scheme|+o|, takes three arguments:\marginnote{Here we are taking a notational liberty: \scheme|+o| actually expects 3 and 4 to be represented as binary, little-endian lists: \mbox{\scheme|(1 1)|} and \mbox{\scheme|(0 0 1)|}, respectively. Zero is represented as the empty list, \scheme|()|.  This representation is extremely flexible, since the lists can contain logic variables---for example, the list \mbox{\scheme|`(1 . ,x)|} represents all odd natural numbers, while \mbox{\scheme|`(0 . ,x)|} represents all positive even naturals.} \mbox{\scheme|(+o 3 4 z)|}.
%
