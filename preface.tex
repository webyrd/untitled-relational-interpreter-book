...
miniKanren has also been implemented in Racket,\marginnote{Links to these implementations, and many other
...
I decided to use Scheme as the host language for this book.
%
...
use\marginnote{Unless otherwise stated, the Scheme code in this book
  ...
  \url{http://www.schemers.org/Documents/Standards/R5RS/}} is a
smaller, simpler language than either Clojure or Racket.
%
With the exception of a few Schemely features (such as \scheme|call/cc|)
that are explained where they first appear, the code should be easily
readable to any functional programmer.
%
In addition, all research on miniKanren---including my dissertation and
papers---use Scheme as the host language.
%
Using Scheme as the host language should make this academic work more
accessible.
