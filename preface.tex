...
In\marginnote{Racket and Clojure editions of this book can be found at: \url{https://github.com/webyrd/relational-programming-in-miniKanren}} order to treat all my readers as first-class citizens, I have
decided to write three editions of this book, one for each of the main
host languages and implementations: Scheme/miniKanren, Racket/cKanren,
