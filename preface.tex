...
Scheme expressions that evaluate to 6, while
\marginnote{Programs that evaluate to themselves are also known as \emph{quines}, in honor of logician Willard Van Orman Quine (1908--2000).} \mbox{\scheme|(evalo exp exp)|} generates Scheme expressions that evaluate to themselves.
