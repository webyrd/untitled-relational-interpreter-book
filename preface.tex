...
%
Relational\marginnote{If you know nothing about logic programming, relational algebra, or databases, \emph{don't panic!} Any aspect of these topics necessary to understand the main text will be explained before hand, or in an appendix.} programming is intimately related to both logic programming
...
to \schemeresult|7|; in this case \scheme|+o| produces multiple
