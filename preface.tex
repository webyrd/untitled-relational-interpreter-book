...
\marginnote{Douglas Hofstadter coined the term \emph{quine} to describe a program that evaluates to itself, in honor of logician Willard Van Orman Quine (1908--2000). Much more on quines can be found in Doug's amazing book, \emph{GEB}: \cite{GEB79}} \mbox{\scheme|(evalo exp exp)|} generates Scheme expressions that evaluate to themselves.
